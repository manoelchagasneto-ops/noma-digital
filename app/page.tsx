...
export default function Home() {
  ...
  return (
    <main className="bg-black text-white overflow-hidden min-h-screen">
      ...
      <div className="fixed top-[-280px] left-[-180px] w-[650px] h-[650px] bg-fuchsia-700/20 blur-[180px] rounded-full -z-10" />

      <div className="fixed bottom-[-280px] right-[-180px] w-[650px] h-[650px] bg-purple-700/20 blur-[180px] rounded-full -z-10" />

      {/* HEADER */}
      <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-xl bg-black/50 border-b border-white/5">

        <div className="max-w-[1450px] mx-auto px-8 h-[88px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <h1 className="text-[48px] leading-none font-black tracking-[0.22em]">
                NOMA
              </h1>

              <p className="text-[10px] tracking-[0.55em] text-white/35 mt-1">
                DIGITAL SOLUTIONS
              </p>
            </div>
          </div>
      ...
      {/* HERO */}
      <section className="max-w-[1450px] mx-auto px-8 pt-[125px]">

        <div className="grid lg:grid-cols-[1fr_0.88fr] gap-[35px] items-start">
          ...
          <div className="pt-[35px]">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-fuchsia-600 flex items-center justify-center shadow-[0_0_20px_rgba(217,70,239,0.55)]"
              >
                <Facebook size={17} />
              </a>
            ...
            {/* BADGE */}
            <div className="inline-flex px-7 py-3 rounded-full border border-fuchsia-500/30 bg-fuchsia-500/10 text-[12px] tracking-[0.28em] text-white/90">
              {t[language].badge}
            </div>

            {/* TITLE */}
            <h2 className="mt-7 text-[82px] xl:text-[92px] leading-[0.88] tracking-[-0.05em] font-black">
            ...
            {/* DESCRIPTION */}
            <p className="mt-8 max-w-[620px] text-white/60 text-[18px] leading-[1.9]">
            ...
            <div className="flex gap-4 mt-10">
              ...
              <button className="px-10 py-5 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 font-semibold shadow-[0_0_35px_rgba(217,70,239,0.45)] hover:scale-105 transition-all duration-300">
                {t[language].start}
              </button>
          ...
          <div className="relative flex justify-end">
            ...
            <div
              className="
                ...
                bg-[#130513]
                shadow-[0_0_60px_rgba(217,70,239,0.28)]
              "
            >
      ...
      >
        ...
        <h3 className="text-[64px] leading-[1.05] font-black mt-5 max-w-[900px]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-7 mt-14">
          ...
          {[
            ...
            >
              ...
              <p className="mt-5 text-white/45 text-[16px] leading-[1.9]">
                {item.desc}
              </p>
            </div>
          ))}
      ...
      >
        ...
        <h3 className="text-[64px] leading-[1.05] font-black mt-5">
          Selected Projects
        </h3>

        <div className="grid md:grid-cols-2 gap-8 mt-14">

          <div className="h-[320px] rounded-[40px] border border-white/10 bg-gradient-to-br from-fuchsia-950 to-purple-950 flex items-center justify-center text-6xl font-black">
            JC Cars
          </div>

          <div className="h-[320px] rounded-[40px] border border-white/10 bg-gradient-to-br from-[#18001f] to-black flex items-center justify-center text-6xl font-black">
            NOMA
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="rounded-[50px] border border-fuchsia-500/20 bg-gradient-to-br from-[#130014] to-[#050008] px-12 py-24 text-center">

          <h3 className="text-[64px] leading-[1.05] font-black max-w-[850px] mx-auto">
            {t[language].cta}
          </h3>
          ...
          <button className="mt-12 px-11 py-5 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 font-semibold text-lg shadow-[0_0_35px_rgba(217,70,239,0.45)] hover:scale-105 transition-all duration-300">
            {t[language].contact}
          </button>
        </div>
      </section>
